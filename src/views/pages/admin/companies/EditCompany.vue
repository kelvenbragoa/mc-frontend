...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/companies/${router.currentRoute.value.params.id}`, values)
        .then((response) => {
            resetForm();
...
const getData = () => {
    axios
        .get(`${baseURL}/companies/${router.currentRoute.value.params.id}/edit`)
        .then((response) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário para Editação de Empresas</h5>
