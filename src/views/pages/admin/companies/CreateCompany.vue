...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`${baseURL}/companies`, values)
        .then((response) => {
            resetForm();
            router.push({ path: '/companies' });
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Empresa criada com sucesso', life: 3000 });
        })
        .catch((error) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Criação de Empresas</h5>
