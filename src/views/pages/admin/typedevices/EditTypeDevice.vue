...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/typedevices/${router.currentRoute.value.params.id}`, values)
        .then((response) => {
            resetForm();
...
const getData = () => {
    axios
        .get(`${baseURL}/typedevices/${router.currentRoute.value.params.id}/edit`)
        .then((response) => {
            ...
            // city.value = retriviedData.value.city;
    ...
    <div className="card" v-if="!isLoadingDiv">
        <div class="col-12">
            <div class="card-w-title">
                ...
                <h5>Editar Tipo de Dispositivo</h5>
            </div>
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Edição de Tipo de Dispositivo</h5>
